...
const Screen = () => {
  ...
  return (
    <div className="bg-bgwhite relative">
      ...
      <div className="circlePosition w-[820px] h-[700px]  bg-bgpurple-5 rounded-full absolute top-[750px] right-[-200px] blur-[90px]"></div>

      <div className="circlePosition w-[620px] h-[600px] bg-bgpurple-2 rounded-full absolute top-[1700px] left-[-200px] blur-[90px]"></div>

      <div className="circlePosition w-[620px] h-[600px] bg-bgpurple-3 rounded-full absolute top-[1700px] left-[-200px] blur-[90px]"></div>

      <div className="circlePosition w-[620px] h-[600px] bg-bgpurple-3 rounded-full absolute top-[2500px] right-[-200px] blur-[90px]"></div>
        ...
        <div className="about relative">
          ...
          <div className="pt-6">
            <a className="text-sm text-purple-1">
              ...
              <br></br>
              <br></br>
              However, my curiosity and eagerness to learn extend far beyond
              these areas. I am eager to embrace new opportunities and excel in
              diverse domains.
            </a>
          </div>
          <div className="mt-5">
            ...
            <VerticalCard
              ...
              description={
                <>
                  ...
                  <span className="font-bold">React Native UI </span> designed
                  to effortlessly streamline the hotel booking experience,
                  offering seamless navigation and visually appealing
                  interfaces.
                </>
              }
            />
          ...
          <div className="flex flex-col items-center justify-center h-full pt-14 space-y-4">
            <a className="text-center text-purple-2">
              ...
              <br></br>Ranging from UI/UX design, illustration, digital
