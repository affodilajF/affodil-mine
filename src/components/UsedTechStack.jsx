...
import seleniumicons from "../assets/selenium.webp";
import goicons from "../assets/golang.webp";
import dockericons from "../assets/docker.webp";
  ...
  return (
    <div className="mt-8">
      ...
      <div className="flex item-center justify-center flex-wrap animate-pulse">
        ...
        <img src={goicons} alt="" className="h-14 w-16  p-1 m-3" />
        <img src={dockericons} alt="" className="h-14 w-16  p-1 m-3" />
      </div>
    </div>
  );
}
